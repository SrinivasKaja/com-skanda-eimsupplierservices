 ...
 * of the canonical classes.
 */
public class EIMXGCalAdaptor extends XmlAdapter<String, XMLGregorianCalendar>
{
	...
	public XMLGregorianCalendar unmarshal(String str) throws Exception
	{
		...
		return EIMDateUtils.getXMLGregorianCalendar(EIMDateUtils.getDateFromString(str,
				EIMMDMConstant.TIMESTAMP_FORMAT_DATE));
	}
	...
	public String marshal(XMLGregorianCalendar str) throws Exception
	{
		...
		return EIMDateUtils
				.formatDateToString(EIMDateUtils.getServiceDateFromXmlGC(str, EIMMDMConstant.DATE_FORMAT_XMLGC), EIMMDMConstant.TIMESTAMP_FORMAT_DATE);
	}
