/**
 * FareTypeTPA_ExtensionsLegsLegTaxes.java
 *
...
public class FareTypeTPA_ExtensionsLegsLegTaxes  implements java.io.Serializable {
    /* Any individual tax applied to the fare */
    private org.opentravel.www.OTA._2003._05.AirTaxType tax;

    public FareTypeTPA_ExtensionsLegsLegTaxes() {
    }
    ...
    /**
     * Gets the tax value for this FareTypeTPA_ExtensionsLegsLegTaxes.
     * 
    ...
    /**
     * Sets the tax value for this FareTypeTPA_ExtensionsLegsLegTaxes.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FareTypeTPA_ExtensionsLegsLegTaxes)) return false;
        FareTypeTPA_ExtensionsLegsLegTaxes other = (FareTypeTPA_ExtensionsLegsLegTaxes) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FareTypeTPA_ExtensionsLegsLegTaxes.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", ">>>>FareType>TPA_Extensions>Legs>Leg>Taxes"));
