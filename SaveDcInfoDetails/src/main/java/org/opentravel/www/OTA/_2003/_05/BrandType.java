...
public class BrandType  implements java.io.Serializable {
    ...
    /**
     * Gets the code value for this BrandType.
     * 
     * @return code
     */
    ...
    /**
     * Sets the code value for this BrandType.
     * 
     * @param code
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", "BrandType"));
