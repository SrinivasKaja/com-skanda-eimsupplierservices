/**
 * FareTypeTPA_ExtensionsLegsLegEquivFare.java
 *
...
public class FareTypeTPA_ExtensionsLegsLegEquivFare  extends org.opentravel.www.OTA._2003._05.CurrencyAmountType  implements java.io.Serializable {
    private java.math.BigDecimal effectivePriceDeviation;  // attribute

    public FareTypeTPA_ExtensionsLegsLegEquivFare() {
    }
    ...
    /**
     * Gets the effectivePriceDeviation value for this FareTypeTPA_ExtensionsLegsLegEquivFare.
     * 
    ...
    /**
     * Sets the effectivePriceDeviation value for this FareTypeTPA_ExtensionsLegsLegEquivFare.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FareTypeTPA_ExtensionsLegsLegEquivFare)) return false;
        FareTypeTPA_ExtensionsLegsLegEquivFare other = (FareTypeTPA_ExtensionsLegsLegEquivFare) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FareTypeTPA_ExtensionsLegsLegEquivFare.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.opentravel.org/OTA/2003/05", ">>>>FareType>TPA_Extensions>Legs>Leg>EquivFare"));
